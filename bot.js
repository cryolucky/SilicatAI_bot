...
const specific = [
  ...
  },
  {
    ...
    text: 'Выделил красной стрелкой. Надо впаять отсутствующие конденсаторы, тогда турбобуст перейдет с дефолтного режима совместимости в обычный, как на плейстейшон файв',
  },
  {
